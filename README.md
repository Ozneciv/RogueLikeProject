...
├── _Project/
│   ├── Animations/     # Controladores e clipes de animação
│   ├── Art/            # Texturas, materiais e modelos
│   ├── Audio/          # Efeitos sonoros e trilhas
│   ├── Effects/        # Shaders e pipelines de efeitos visuais
│   ├── Enemies/        # Prefabs e comportamentos de IA dos inimigos
│   ├── Items_and_Crafting/ # Tabelas de dados e lógica de itens
│   ├── Player/         # Controles de movimentação, atributos e combate do jogador
│   ├── Scenes/         # Cenas do jogo (Base, Arenas de Combate)
│   ├── Scripts/        # Código-fonte principal organizado por sistemas
│   ├── UI/             # Interfaces de usuário, menus e HUD
│   └── VFX/            # Efeitos de partículas e materiais de impacto
└── GDD/                # Game Design Document completo (.tex)
```
...
1. Clone o repositório em sua máquina local:
   ```bash
   git clone https://github.com/Ozneciv/RogueLikeProject.git
   ```
2. Abra o projeto utilizando o Unity Hub na versão correspondente configurada no projeto.
3. Abra a cena localizada em `Assets/_Project/Scenes/Base.unity` para iniciar a execução no Editor.
